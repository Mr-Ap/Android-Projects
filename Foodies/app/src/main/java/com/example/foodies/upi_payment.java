...
public class upi_payment extends AppCompatActivity {
    ...
    public static int tot=Cart.total;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                amountEt.setText(Integer.toString(tot));
    ...
    final EditText edtAddress=new EditText(upi_payment.this);
    private void upiPaymentDataOperation(ArrayList<String> data) {
        if (isConnectionAvailable(upi_payment.this)) {
            ...
            if (status.equals("success")) {
                ...
                ProgressDialog progressDialog=new ProgressDialog(upi_payment.this);
                ...
                Toast.makeText(upi_payment.this,"Thank you , Order Placed..!",Toast.LENGTH_SHORT).show();
        ...
        startActivity(new Intent(upi_payment.this,Home.class));
    }
